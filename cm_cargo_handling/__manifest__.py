# -*- coding: utf-8 -*-
{
	...
	'depends':['base','sale','cm_cai','account','cm_banks','account_fiscal_year_period','report_xlsx','mail','cm_sales', 'settlement', 'year_budget'],
	'data':[
		'security/groups.xml',
		...
		'wizards/ventas_cliente_wizard_view.xml',
