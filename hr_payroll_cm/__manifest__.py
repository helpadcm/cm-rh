# -*- coding: utf-8 -*-
{
    ...
    'description': """
        ...
        """,
    'depends': ['hr_employee_cm', 'hr_payroll', 'hr_contract_cm','hr_attendance_reports_cm','mail','hr_turns_cm','report_xlsx', 'hr_absences_cm', 'hr_payroll_account','account','hr_work_entry_enterprise','documents_hr_payroll'],
    'data': [
