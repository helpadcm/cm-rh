...
class ReportAgedPartnerBalance(models.AbstractModel):
    ...
    def _get_partner_move_lines(self, account_type, partner_ids,
                                date_from, target_move, period_length, currency_id):
        ...
        same_currency = True
        user_currency = currency_id or user_company.currency_id
        ...
        query = '''
            SELECT DISTINCT l.partner_id, UPPER(res_partner.name), res_partner.is_customer
            ...
            WHERE (l.account_id = account_account.id)
                ...
                AND res_partner.is_customer = true
    ...
    def _get_report_values(self, docids, data=None):
        ...
        currency_id = data['form']['currency_id'][0]
        currency_report_id = self.env['res.currency'].browse(currency_id)
        movelines, total, dummy = self._get_partner_move_lines(
            account_type, partner_ids, date_from, target_move, data['form']['period_length'], currency_report_id
        )
        return {
            'doc_ids': self.ids,
            'doc_model': model,
