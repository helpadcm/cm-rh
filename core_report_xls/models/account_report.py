...
class AccountReport(models.Model):
    ...
    def _custom_options_initializer(self, report, options, previous_options=None):
        # solo aplicar al reporte "aged receivable"
        if report['report_id'] == self.env.ref("account_reports.aged_receivable_report").id:
            options['partner_type'] = (
                previous_options.get('partner_type') if previous_options else 'all'
            )

        return super()._custom_options_initializer(report, options, previous_options)
